...
export class MaterialService {
    ...
    createTexto(data: any) {
        return this.http.post(`${API_URL}/createTexto`, data, {
            context: checktoken(),
        });
    }

    updateTexto(id: number, data: any) {
        return this.http.put(`${API_URL}/updateTexto/${id}`, data, {
            context: checktoken(),
        });
    }

    deleteTexto(id: number) {
        return this.http.delete(`${API_URL}/deleteTexto/${id}`, {
            context: checktoken(),
        });
    }
    ...
    getTipoTexto() {
        return this.http.get(`${API_URL}/getTipoTextos`, {
            context: checktoken(),
        });
    }

    createTipoTexto(data: any) {
        return this.http.post(`${API_URL}/createTipoTexto`, data, {
            context: checktoken(),
        });
    }

    updateTipoTexto(id: number, data: any) {
        return this.http.put(`${API_URL}/updateTipoTexto/${id}`, data, {
            context: checktoken(),
        });
    }

    deleteTipoTexto(id: number) {
        return this.http.delete(`${API_URL}/deleteTipoTexto/${id}`, {
            context: checktoken(),
        });
    }
    ...
    getTipoIdiomaTexto() {
        return this.http.get(`${API_URL}/getTipoIdiomaTextos`, {
            context: checktoken(),
        });
    }

    createTipoIdiomaTexto(data: any) {
        return this.http.post(`${API_URL}/createTipoIdiomaTexto`, data, {
            context: checktoken(),
        });
    }

    updateTipoIdiomaTexto(id: number, data: any) {
        return this.http.put(`${API_URL}/updateTipoIdiomaTexto/${id}`, data, {
            context: checktoken(),
        });
    }

    deleteTipoIdiomaTexto(id: number) {
        return this.http.delete(`${API_URL}/deleteTipoIdiomaTexto/${id}`, {
            context: checktoken(),
        });
    }
    ...
    getTipoCategoriaTexto() {
        return this.http.get(`${API_URL}/getTipoCategoriaTextos`, {
            context: checktoken(),
        });
    }

    createTipoCategoriaTexto(data: any) {
        return this.http.post(`${API_URL}/createTipoCategoriaTexto`, data, {
            context: checktoken(),
        });
    }
    ...
    updateTipoCategoriaTexto(id: number, data: any) {
        return this.http.put(
            `${API_URL}/updateTipoCategoriaTexto/${id}`,
            data,
            { context: checktoken() }
        );
    }
    ...
    deleteTipoCategoriaTexto(id: number) {
        return this.http.delete(`${API_URL}/deleteTipoCategoriaTexto/${id}`, {
            context: checktoken(),
        });
    }
    ...
    getTipoExtensionTexto() {
        return this.http.get(`${API_URL}/getTipoExtensionTextos`, {
            context: checktoken(),
        });
    }

    createTipoExtensionTexto(data: any) {
        return this.http.post(`${API_URL}/createTipoExtensionTexto`, data, {
            context: checktoken(),
        });
    }
    ...
    updateTipoExtensionTexto(id: number, data: any) {
        return this.http.put(
            `${API_URL}/updateTipoExtensionTexto/${id}`,
            data,
            { context: checktoken() }
        );
    }
    ...
    deleteTipoExtensionTexto(id: number) {
        return this.http.delete(`${API_URL}/deleteTipoExtensionTexto/${id}`, {
            context: checktoken(),
        });
    }
    ...
    getMateriaTexto() {
        return this.http.get(`${API_URL}/getMateriaTextos`, {
            context: checktoken(),
        });
    }

    createMateriaTexto(data: any) {
        return this.http.post(`${API_URL}/createMateriaTexto`, data, {
            context: checktoken(),
        });
    }
    ...
    updateMateriaTexto(mattexid: number, data: any) {
        return this.http.put(
            `${API_URL}/updateMateriaTexto/${mattexid}`,
            data,
            {
                context: checktoken(),
            }
    ...
    deleteMateriaTexto(mattexid: number) {
        return this.http.delete(`${API_URL}/deleteMateriaTexto/${mattexid}`, {
            context: checktoken(),
        });
    }

    getTextoCombo() {
        return this.http.get(`${API_URL}/getListTextoCombo`, {
            context: checktoken(),
        });
    }
