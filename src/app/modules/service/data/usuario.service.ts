...
export class UsuarioService {
    ...
    getTipoPersonaDocente() {
        return this.http.get(`${API_URL}/tipoPersonaDocente`, {
            context: checktoken(),
        });
    }
    ...
    buscarUsuario(criterio: any): Observable<any> {
        return this.http.post<any>(`${API_URL}/buscarUsuario`, criterio, {
            context: checktoken(),
        });
    }

    requestChangePassword(criterio: any) {
        return this.http.post(`${API_URL}/requestChangePassword`, criterio, {
            context: checktoken(),
        });
    }
    ...
    changePassword(criterio: any) {
        return this.http.post(`${API_URL}/changePassword`, criterio, {
            context: checktoken(),
        });
    }
}
