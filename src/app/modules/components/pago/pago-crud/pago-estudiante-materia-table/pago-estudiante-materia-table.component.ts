...
@Component({
    selector: 'app-pago-estudiante-materia-table',
    templateUrl: './pago-estudiante-materia-table.component.html',
    styleUrls: ['./pago-estudiante-materia-table.component.scss'],
})
export class PagoEstudianteMateriaTableComponent implements OnInit {
    // Inputs
    @Input() listarPagoEstudianteMateria: Pago[] = [];
    @Input() usuario: Usuario = new Usuario();
    @Input() verPagosEstudianteClicked: boolean;
    @Input() loading2: boolean;
    @Input() userProfilePhoto: string;
    @Input() curnombre: string;
    @Input() matnombre: string;
