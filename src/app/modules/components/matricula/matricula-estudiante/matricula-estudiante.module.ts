...
import { MatriculaEstudianteRoutingModule } from './matricula-estudiante-routing.module';
...
@NgModule({
    imports: [
        CommonModule,
        MatriculaEstudianteRoutingModule,
        TableModule,
        FileUploadModule,
        FormsModule,
        ButtonModule,
...
export class MatriculaEstudianteModule { }
