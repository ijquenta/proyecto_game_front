...
import { DocenteMiAdmisionRoutingModule } from './docente-mi-admision-routing.module';
...
@NgModule({
    imports: [
        ...
        AutoCompleteModule,
        CommonModule,
        DocenteMiAdmisionRoutingModule,
        TableModule,
        FileUploadModule,
        FormsModule,
        ButtonModule,
    ...
    declarations: [DocenteMiAdmisionComponent],
    providers: [UsuarioService, ReporteService, EstudianteService, PersonaService]
})
export class DocenteMiAdmisionModule { }
