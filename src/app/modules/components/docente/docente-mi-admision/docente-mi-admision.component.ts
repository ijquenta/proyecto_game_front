...
@Component({
    templateUrl: './docente-mi-admision.component.html',
    providers: [MessageService],
    styleUrls: ['../../../../app.component.css']
})
export class DocenteMiAdmisionComponent implements AfterViewInit, OnInit {
    ...
    ngOnInit() {
        this.items = [{ label: 'Docente'}, { label: 'Mi Admisión', routerLink:''},];
