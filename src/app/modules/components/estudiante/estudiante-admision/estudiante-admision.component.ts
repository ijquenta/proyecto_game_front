...
export class EstudianteAdmisionComponent implements AfterViewInit, OnInit {
    ...
    ngAfterViewInit() {
        // Aquí puedes inicializar cualquier cosa que dependa de la referencia del DOM
    ...
    seleccionarPersona(event: any){
        ...
        this.listarInformacionPersonal(this.persona.perid);
        this.listarInformacionAcademica(this.persona.perid);
        this.listarInformacionMinisterial(this.persona.perid);
        this.listarDocumentoAdmision(this.persona.perid);
    }
