...
import { EstudianteMiAdmisionRoutingModule } from './estudiante-mi-admision-routing.module';
...
@NgModule({
    imports: [
        ...
        AutoCompleteModule,
        CommonModule,
        EstudianteMiAdmisionRoutingModule,
        TableModule,
        FileUploadModule,
        FormsModule,
        ButtonModule,
    ...
    declarations: [EstudianteMiAdmisionComponent],
    providers: [UsuarioService, ReporteService, EstudianteService, PersonaService]
})
export class EstudianteMiAdmisionModule { }
